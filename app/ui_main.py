...
class MainWindow(QMainWindow):
    ...
    def _setup_ui(self):
        ...
        self.select_path_btn.setFixedSize(36, 28)
        self.select_path_btn.setStyleSheet("padding: 0px; font-size: 14px;")
        self.select_path_btn.setToolTip("Browse Game Folder")
        ...
        self.add_area_btn.setStyleSheet("padding: 0px; font-size: 14px;")
        self.remove_area_btn = QPushButton("🗑️")
        self.remove_area_btn.setToolTip("Remove Selected Area")
        self.remove_area_btn.setStyleSheet("color: #ef4444; border-color: #ef4444; padding: 0px; font-size: 14px;")
        ...
        self.sound_browse.setFixedSize(36, 28)
        self.sound_browse.setStyleSheet("padding: 0px; font-size: 14px;")
        self.sound_browse.setToolTip("Browse Sound File")
        ...
        self.stop_btn.setStyleSheet("padding: 0px; font-size: 18px;")
        self.stop_btn.setToolTip("Stop Monitoring")
        
        self.reset_btn = QPushButton("🔄")
        self.reset_btn.setFixedSize(45, 45)
        self.reset_btn.setStyleSheet("padding: 0px; font-size: 18px;")
